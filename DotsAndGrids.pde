...
// Hartmut Bohnacker, Beenedikt Gross, Julia Laub, Claudius Lazzeroni
    ...
    if (get(px, py) != color(360) || reachedBorder) {
      ...
      if (distance >= minLength) {
        ...
        if(ellipseSize >  4.9)
        {
          noStroke();
          fill(255, 20);
          ellipse(posXcross, posYcross, ellipseSize*50, ellipseSize*50);
        }
        */
        ...
        noStroke();
        fill(0);
        ellipse(posXcross, posYcross, ellipseSize, ellipseSize);
